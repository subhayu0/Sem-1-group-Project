...
# # Title Label
# title_label = tk.Label(root, text="Flight", font=("Arial", 16))
# title_label.pack(pady=10)

# # Frame for flight type selection
# flight_type_frame = tk.Frame(root)
# flight_type_frame.pack(pady=5)

# flight_type_label = tk.Label(flight_type_frame, text="Book Domestic Flight")
# flight_type_label.grid(row=0, column=0, columnspan=2)

# # Radio buttons for flight type
# flight_type = tk.StringVar(value="One Way")
# one_way_radio = tk.Radiobutton(flight_type_frame, text="One Way", variable=flight_type, value="One Way")
# return_radio = tk.Radiobutton(flight_type_frame, text="Return", variable=flight_type, value="Return")
...
# from_label = tk.Label(form_frame, text="From")
...
# to_label = tk.Label(form_frame, text="To")
...
# departure_label = tk.Label(form_frame, text="Departure Date")
...
# adult_label = tk.Label(form_frame, text="Adult")
...
# child_label = tk.Label(form_frame, text="Child")
