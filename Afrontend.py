...
#     conn.commit()
#     conn.close()
#     refresh_transactions()  # Refresh the UI after inserting
 
# # Function to fetch transactions from the database
# def fetch_transactions():
#     conn = sqlite3.connect('transactions.db')
#     cursor = conn.cursor()
#     cursor.execute("SELECT transaction_name, amount FROM transactions")
#     rows = cursor.fetchall()
#     conn.close()
#     return rows
 
# # Function to refresh the Treeview with the latest transactions
# def refresh_transactions():
#     for item in tree.get_children():
#         tree.delete(item)
#     transactions = fetch_transactions()
#     for trans, amount in transactions:
#         tree.insert('', tk.END, values=(trans, f"{amount:+.2f}"))
...
#     try:
#         logo_image = tk.PhotoImage(file=r"C:\Users\ASUS\Downloads\purse-pal-high-resolution-logo-transparent (1).png")
#         home_icon = tk.PhotoImage(file=r"C:\Users\ASUS\Downloads\home icon (1).png")
#         statement_icon = tk.PhotoImage(file=r"C:\Users\ASUS\Downloads\evaluation (1).png")
#         contact_icon = tk.PhotoImage(file=r"C:\Users\ASUS\Downloads\phone (1).png")
#         settings_icon = tk.PhotoImage(file=r"C:\Users\ASUS\Downloads\setting (1).png")
...
#     global tree  # To be accessible from other functions
