...
def create_movie_poster(image_path, title_text):
    ...
    # Load image (you should replace these with actual paths to the images)
...
create_movie_poster(r"C:\Users\ASUS\Downloads\image (7) (1).png", "Deadpool & Wolverine")
create_movie_poster(r"C:\Users\ASUS\Downloads\image (8) (1).png","Stree2")
create_movie_poster(r"C:\Users\ASUS\Downloads\image (9) (1).png","Bulaki")
